...
export interface XMNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface XMNFT extends BaseContract {
  connect(runner?: ContractRunner | null): XMNFT;
  waitForDeployment(): Promise<this>;

  interface: XMNFTInterface;
